  ...
  def create
    ...
    respond_to do |format|
      if @medical_specialization.save
        format.html { redirect_to @medical_specialization, notice: CrudTranslations.model_was_created(@medical_specialization) }
  ...
  def update
    ...
    respond_to do |format|
      if @medical_specialization.update_attributes(params[:medical_specialization])
        format.html { redirect_to @medical_specialization, notice: CrudTranslations.model_was_updated(@medical_specialization) }
