...
class AttentionPeriodTest < ActiveSupport::TestCase
	...
	test "begin time on a date" do
		...
		# Perform...
		time = period.begin_time_on time

		# Assert...
		assert_equal Time.zone.local(2013,1,1,9,0), time
	end
	...
	test "end time on a time" do
		...
		# Perform...
		time = period.end_time_on time

		# Assert...
		assert_equal Time.zone.local(2013,1,1,13,0), time
	end
