...
class MedicalsControllerTest < ActionController::TestCase
  ...
  test "should create medical" do
    assert_difference('Medical.count') do
      post :create, medical: { cuil: @medical.cuil, dni: @medical.dni, email: @medical.email, firstname: @medical.firstname, lastname: @medical.lastname, specialization: @medical.specialization }
    end
  ...
  test "should update medical" do
    put :update, id: @medical, medical: { cuil: @medical.cuil, dni: @medical.dni, email: @medical.email, firstname: @medical.firstname, lastname: @medical.lastname, specialization: @medical.specialization }
    assert_redirected_to medical_path(assigns(:medical))
  end
